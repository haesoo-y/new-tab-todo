...
- 다양한 기능을 넣은 새 탭 페이지 개발 ( to-do리스트, 시간, 검색엔진, 날씨, 기온별 의상추천)
...
3. 현재 위치의 날씨를 표시함
    ...
    - geolocation으로 사용자의 위치 위도 경도를 받고, 거부 시 서울의 위경도 데이터를 받음
...
6. todo리스트가 많아지면 스크롤이 생성됨
    ...
    - scrollbar의 너비를 지정하고 스타일을 각각 부여함
    - track과 thumb에 border-radius 속성으로 스타일을 변경함
    - thumb에 padding을 주기위해서 background-clip과 border을 사용함
7. Netlify를 이용해서 배포함
